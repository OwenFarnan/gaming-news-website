<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleDetails.aspx.cs"
    Inherits="Project02.ArticleDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Atricle Details</title>
            ...
            <div id="content-wrapper">
                <div id="inner-content">
                    <div id="entry">
                        <div id="post-top">
                            <h3 id="post-title">
                                <label runat="server" id="lblTitle"></label></h3>
                            <div class="post-meta">
                                <span class="author">Posted by: <label runat="server" id="lblPostedBy"></label></span>
                                <span class="posting-date"><label runat="server" id="lblCreatedDate"></label></span>
                                <span class="label"><label runat="server" id="lblCategory"></label></span> 
                            </div>
                        </div>
                        <div class="entry-content">
                            <p runat="server" id="description"></p>
                            <p align="center"><img runat="server" id="articleImg" alt="" width="400" /></p>
                        </div>
                    </div>
                </div>
                <div class="clear">
