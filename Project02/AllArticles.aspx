<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllArticles.aspx.cs" Inherits="Project02.AllArticles" %>
            ...
            <div id="content-wrapper">
                <div id="inner-content">
                    <div id="entry">
                        <h1 class="Ttitle">
                            All Article 
                            	<asp:Button runat="server" Text="New Article" id="BtnNewArticle" OnClick="BtnNewArticle_Click" CssClass="newartbutt"/></h1>
                            <br clear="all" />
                                    ...
                                    <telerik:RadGrid ID="grdArticles" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn DataField="Title" EmptyDataText="-" HeaderStyle-HorizontalAlign="Left"
                                                    HeaderText="Title" ItemStyle-HorizontalAlign="Left" ShowFilterIcon="false" UniqueName="championShip"
                                                    CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn DataField="Description" EmptyDataText="-" HeaderStyle-HorizontalAlign="Left"
                                                ...
                                                <telerik:GridTemplateColumn AllowFiltering="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnDelete" ImageUrl="~/images/delete.png" Height="20px" Width="20px"
                                                            CommandName="Del" CommandArgument='<%# Eval("ID")+","+Eval("ImgPath") %>' runat="server" OnClientClick="return confirm('Do you want to delete this record?');" />
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                            </Columns>
